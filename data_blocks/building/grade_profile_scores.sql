--ACCESS=teacher
SELECT s.grade_level, p.sis_id,  s.student_id, p.person_id, p.first_name, p.last_name, a_profile_student_scores(p.person_id,:profile_id, school_year) AS scores FROM
