...
SELECT 
  ...
  JOIN p_students st ON st.person_id = a.person_id
  JOIN p_people pp oN st.person_id=pp.person_id
  JOIN s_group_members gm ON st.student_id = gm.student_id
WHERE 
...
ORDER BY date_taken, last_name, first_name